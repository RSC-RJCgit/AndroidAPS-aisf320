...
- See `.Codex/CLAUDE_COMMANDS.md` for platform-specific working commands
...
- Repeatable procedures live in `.Codex/skills/<name>/SKILL.md` and load on demand. Use one when the
...
- **Keep a skill up to date as you use it.** If you hit a step that is missing, add it before you
  ...
  worse than none, because it gets believed. The same goes for `.Codex/procedures/*.md`.
...
- **Method and procedure** (how to flip a module, how to review, how to audit memory) → a skill or
  `.Codex/procedures/*.md` in the repo. Everybody gets it and git carries it between machines.
...
- **For migrations**: Follow procedures in `.Codex/procedures/migration.md`
