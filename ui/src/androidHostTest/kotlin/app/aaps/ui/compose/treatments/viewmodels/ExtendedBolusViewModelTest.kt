...
internal class ExtendedBolusViewModelTest {
    ...
    private lateinit var sut: ExtendedBolusViewModel
    ...
    fun defaultUiStateIsNotInRemovingModeAndHasNoSelection() {
        ...
        assertThat(state.extendedBoluses).isEmpty()
