        ...
        for (r in records) {
            ...
            addSplitRow(
                binding.historyTime, table, cells = listOf(
                    ...
                    Cell(autoIsfHistoryExporter.mildBstStr(r.timestamp, apsResults), colorInsulin),
                    ...
                    Cell(autoIsfHistoryExporter.notesWithRawTag(r.timestamp, allCarePortalNotes, allRecords, allRawReadings), colorTime)
                )
            )
        }
    ...
    private fun addHeaderRows() {
        ...
        addSplitRow(
            binding.historyCorner, binding.historyHeader, cells = listOf(
                ...
                Cell("SMB", colorInsulin, span = 5, bold = true),
                Cell("iobTH", colorHeader, bold = true),
                Cell("Settings", colorHeader, span = 3, bold = true),
                // acce/dAcc/dAccUkf/Δ/SΔ/LΔ/ukfRBGL/RawUKF5/RawUKF15 = 9.
                // UKF3 (dAccU3/u3RBGL/RawU3_*), raw Libre (rBGL/rΔ*), Int5, HP3 and LowBG were
                // dropped 2026-09-04 -- UKF3 graph is gone; UKF1 columns are the dosing signal.
                Cell("BG", colorGlucose, span = 9, bold = true),
                // Req/TBR/IOB/IOBd5/Basal/COB/COBt/carbAbs/HP/HP2 = 10.
        ...
        addSplitRow(
            binding.historyCorner, binding.historyHeader, cells = listOf(
                ...
                Cell("MildBst", colorInsulin, bold = true),
