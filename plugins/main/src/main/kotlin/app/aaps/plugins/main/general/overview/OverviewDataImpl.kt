...
class OverviewDataImpl @Inject constructor(
    ...
    override fun reset() {
        ...
        l5DeltaSeries = PointsWithLabelGraphSeries<DataPointWithLabelInterface>()
    ...
    */
    ...
    override var l5DeltaSeries: SeriesData = PointsWithLabelGraphSeries<DataPointWithLabelInterface>()
