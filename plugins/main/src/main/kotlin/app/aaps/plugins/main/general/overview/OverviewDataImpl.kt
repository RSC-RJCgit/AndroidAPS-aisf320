...
class OverviewDataImpl @Inject constructor(
    ...
    override fun reset() {
        ...
        tempBasalAcceIsfSeries = LineGraphSeries<ScaledDataPoint>()
        tempBasalBgIsfSeries = LineGraphSeries<ScaledDataPoint>()
        tempBasalPpIsfSeries = LineGraphSeries<ScaledDataPoint>()
        tempBasalDuraIsfSeries = LineGraphSeries<ScaledDataPoint>()
        ...
        activityPeakSeries = PointsWithLabelGraphSeries<DataPointWithLabelInterface>()
        maxCarbAbsorptionValue = 0.0
        ...
        noteArrowheadSeries = PointsWithLabelGraphSeries<DataPointWithLabelInterface>()
        rawBgSeries = emptyList()
        rawBgSmoothedSeries = LineGraphSeries<DataPoint>()
        libreSpecialPreUkfSeries = LineGraphSeries<DataPoint>()
        libreSpecialFromUkf1Series = LineGraphSeries<DataPoint>()
        rawBgSmoothedSeriesGraph5 = LineGraphSeries<DataPoint>()
        libreSpecialPreUkfSeriesGraph5 = LineGraphSeries<DataPoint>()
        libreSpecialFromUkf1SeriesGraph5 = LineGraphSeries<DataPoint>()
        noisyBgDeltaSeries = PointsWithLabelGraphSeries<DataPointWithLabelInterface>()
        ukfDeltaSeries = PointsWithLabelGraphSeries<DataPointWithLabelInterface>()
    ...
    */
    ...
    override var tempBasalAcceIsfSeries: SeriesData = LineGraphSeries<ScaledDataPoint>()
    override var tempBasalBgIsfSeries: SeriesData = LineGraphSeries<ScaledDataPoint>()
    override var tempBasalPpIsfSeries: SeriesData = LineGraphSeries<ScaledDataPoint>()
    override var tempBasalDuraIsfSeries: SeriesData = LineGraphSeries<ScaledDataPoint>()
    ...
    override var activityPeakSeries: SeriesData = PointsWithLabelGraphSeries<DataPointWithLabelInterface>()
    override var maxCarbAbsorptionValue = 0.0
    override val carbAbsorptionScale = Scale()
    override var carbAbsorptionSeries: SeriesData = FixedLineGraphSeries<ScaledDataPoint>()
    ...
    override var noteArrowheadSeries: SeriesData = PointsWithLabelGraphSeries<DataPointWithLabelInterface>()
    ...
    override var rawBgSeries: List<SeriesData> = emptyList()
    override var rawBgSmoothedSeries: SeriesData = LineGraphSeries<DataPoint>()
    override var libreSpecialPreUkfSeries: SeriesData = LineGraphSeries<DataPoint>()
    override var libreSpecialFromUkf1Series: SeriesData = LineGraphSeries<DataPoint>()
    override var rawBgSmoothedSeriesGraph5: SeriesData = LineGraphSeries<DataPoint>()
    override var libreSpecialPreUkfSeriesGraph5: SeriesData = LineGraphSeries<DataPoint>()
    override var libreSpecialFromUkf1SeriesGraph5: SeriesData = LineGraphSeries<DataPoint>()
    override var noisyBgDeltaSeries: SeriesData = PointsWithLabelGraphSeries<DataPointWithLabelInterface>()
    override var ukfDeltaSeries: SeriesData = PointsWithLabelGraphSeries<DataPointWithLabelInterface>()
