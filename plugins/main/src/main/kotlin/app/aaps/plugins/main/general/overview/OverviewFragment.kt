...
class OverviewFragment : DaggerFragment(), View.OnClickListener, OnLongClickListener {
    ...
    private fun ttCodesList(): List<TtCode> = listOf(
        ...
        TtCode.Stepped("T1 tod offset 00-02h", 5.092, 5.094, "-0.5", "+0.5"),
        TtCode.Stepped("T2 tod offset 02-04h", 5.098, 5.100, "-0.5", "+0.5"),
        TtCode.Stepped("T3 tod offset 04-06h", 5.104, 5.106, "-0.5", "+0.5"),
        TtCode.Stepped("T4 tod offset 06-09h", 5.110, 5.112, "-0.5", "+0.5"),
        TtCode.Stepped("T5 tod offset 09-12h", 5.116, 5.118, "-0.5", "+0.5"),
        TtCode.Stepped("T6 tod offset 12-18h", 5.122, 5.124, "-0.5", "+0.5"),
        TtCode.Stepped("T7 tod offset 18-22h", 5.128, 5.130, "-0.5", "+0.5"),
        TtCode.Stepped("T8 tod offset 22-00h", 5.134, 5.136, "-0.5", "+0.5"),
