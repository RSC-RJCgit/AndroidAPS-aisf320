...
class OverviewFragment : DaggerFragment(), View.OnClickListener, OnLongClickListener {
    ...
    private fun processButtonsVisibility() {
        ...
        runOnUiThread {
            ...
            if (quickWizardEntry != null && lastBG != null && profile != null && pump.isInitialized() && loop.runningMode != RM.Mode.DISCONNECTED_PUMP && !pump.isSuspended()) {
                ...
                if (wizard.calculatedTotalInsulin <= 0 && quickWizardEntry.carbs() <= 0) binding.buttonsLayout.quickWizardButton.visibility = View.GONE
    ...
    private fun ttCodesList(act: androidx.fragment.app.FragmentActivity): List<TtCode> = listOf(
        ...
        TtCode.Stepped("MildBst ratio", 5.052, 5.054, "-0.05", "+0.05", currentValue = { "Current: ${"%.2f".format(preferences.get(DoubleKey.ApsAutoIsfMildBoostRatio))}" }),
