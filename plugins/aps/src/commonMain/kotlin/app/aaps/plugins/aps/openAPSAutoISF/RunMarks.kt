...
internal object RunMark {
    ...
    const val TOD_0609_DOWN = "TodOffset0609DownTT"
    const val TOD_0609_UP = "TodOffset0609UpTT"
    const val TOD_0912_DOWN = "TodOffset0912DownTT"
    const val TOD_0912_UP = "TodOffset0912UpTT"
    const val TOD_1218_DOWN = "TodOffset1218DownTT"
    const val TOD_1218_UP = "TodOffset1218UpTT"
    const val TOD_1822_DOWN = "TodOffset1822DownTT"
    const val TOD_1822_UP = "TodOffset1822UpTT"
    ...
    const val MJ_ACTIVE = "MjStateActiveTT"
    const val MJ2 = "MjStateMj2TT"
    const val PROFILE_STANDARD = "ProfileStandardTT"
    const val PROFILE_LOW = "ProfileLowTT"
    const val SENSOR_AGE_CODE = "SensorAgeCodeToggleTT"
    const val LIBRE_UKF1 = "LibreUkf1ToggleTT"
    const val MJ_START = "MjStartActionTT"
    const val MJ_RESTORE = "MjRestoreActionTT"
    const val STEROID_START = "SteroidStartActionTT"
    const val STEROID_130 = "SteroidIncrease130ActionTT"
    const val STEROID_150 = "SteroidIncrease150ActionTT"
    const val STEROID_190 = "SteroidIncrease190ActionTT"
    ...
    const val PROFILE_BATCH_REVERT_C_TT = "ProfileBatchRevertCToggleTT"
    const val TIER_SET_A = "ProfileBatchSetATT"
    const val TIER_SET_B = "ProfileBatchSetBTT"
    const val TIER_SET_C = "ProfileBatchSetCTT"
    const val FAST_RISE = "FastRiseToggleTT"
    const val LOW_REBOUND = "LoRebToggleTT"
    const val T3_UNRESTRICTED = "T3UnrestrictedToggleTT"
    const val BOOST_SCALE_DOWN = "BoostScaleDownTT"
    const val BOOST_SCALE_UP = "BoostScaleUpTT"
    const val BOOST_MAX_DOWN = "BoostMaxDownTT"
    const val BOOST_MAX_UP = "BoostMaxUpTT"
    const val BOOST_IOB_DOWN = "BoostIobMaxDownTT"
    const val BOOST_IOB_UP = "BoostIobMaxUpTT"
    const val DURA_WEIGHT_DOWN = "DuraWeightDownTT"
