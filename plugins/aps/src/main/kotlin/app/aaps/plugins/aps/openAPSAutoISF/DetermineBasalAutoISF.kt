...
class DetermineBasalAutoISF @Inject constructor(
    ...
    fun determine_basal(
        ...
        if (autoIsfMode) {
            consoleError.add("----------------------------------")
            consoleError.add("start AutoISF ${profile.autoISF_version} __ 320.TDD024NS6")
            consoleError.add("----------------------------------")
        ...
        rT.reason.append(
            " 320.TDD024NS6 COB: ${round(meal_data.mealCOB, 1).withoutZeros()}, Dev: ${convert_bg(deviation.toDouble())}, BGI: ${convert_bg(bgi)}, ISF: ${convert_isf(sens)}, CR: ${
...
// =====================================================
                    ...
                    SDelta >= 0.25 * 18 &&
                    LDelta <= 0.08 * 18 &&
                    SDelta >= 3.0 * (LDelta + 0.01)   // SDelta disproportionate to LDelta
                ) {
                    microBolus = microBolus * 0.5
...
DetermineBasalAutoISF.kt 320.TDD024NS6
 */