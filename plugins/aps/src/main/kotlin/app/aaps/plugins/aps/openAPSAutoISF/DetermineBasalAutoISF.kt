...
class DetermineBasalAutoISF @Inject constructor(
    ...
    fun determine_basal(
        ...
        if (autoIsfMode) {
            consoleError.add("----------------------------------")
            consoleError.add("start AutoISF ${profile.autoISF_version} __ 320TDD2AU432")
            consoleError.add("----------------------------------")
        ...
        rT.reason.append(
            " 320TDD2AU432 COB: ${round(meal_data.mealCOB, 1).withoutZeros()}, Dev: ${convert_bg(deviation.toDouble())}, BGI: ${convert_bg(bgi)}, ISF: ${convert_isf(sens)}, CR: ${
...
/*
DetermineBasalAutoISF.kt320TDD2AU432
*/
