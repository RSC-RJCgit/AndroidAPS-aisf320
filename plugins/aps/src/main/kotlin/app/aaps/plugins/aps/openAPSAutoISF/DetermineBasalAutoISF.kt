...
class DetermineBasalAutoISF @Inject constructor(
    ...
    fun determine_basal(
        ...
        rT.reason.append(
            " 320TDD2AU355 COB: ${round(meal_data.mealCOB, 1).withoutZeros()}, Dev: ${convert_bg(deviation.toDouble())}, BGI: ${convert_bg(bgi)}, ISF: ${convert_isf(sens)}, CR: ${
...
/*
DetermineBasalAutoISF.kt320TDD2AU355
*/
