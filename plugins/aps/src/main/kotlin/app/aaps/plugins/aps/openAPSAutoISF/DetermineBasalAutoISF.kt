...
class DetermineBasalAutoISF @Inject constructor(
    ...
    fun determine_basal(
        ...
        if (autoIsfMode) {
            consoleError.add("----------------------------------")
            consoleError.add("start AutoISF ${profile.autoISF_version} __ cl050")
            consoleError.add("----------------------------------")
        ...
        rT.reason.append(
            " cl050 COB: ${round(meal_data.mealCOB, 1).withoutZeros()}, Dev: ${convert_bg(deviation.toDouble())}, BGI: ${convert_bg(bgi)}, ISF: ${convert_bg(sens)}, CR: ${
...
// =====================================================
                    ...
                    //microBolus > 0.3 //not used except cl050
                ) {
...
/*/ =====================================================
// FAST RISE SECONDARY CAP. .not used except cl050not used except gpt047
// =====================================================
...
cl050 DetermineBasalAutoISF.kt
 */