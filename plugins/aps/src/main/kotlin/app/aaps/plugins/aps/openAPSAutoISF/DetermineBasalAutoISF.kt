...
class DetermineBasalAutoISF @Inject constructor(
    ...
    fun determine_basal(
        ...
        if (autoIsfMode) {
            consoleError.add("----------------------------------")
            consoleError.add("start AutoISF ${profile.autoISF_version} __ 035058batt")
            consoleError.add("----------------------------------")
        ...
        rT.reason.append(
            " 035058batt COB: ${round(meal_data.mealCOB, 1).withoutZeros()}, Dev: ${convert_bg(deviation.toDouble())}, BGI: ${convert_bg(bgi)}, ISF: ${convert_bg(sens)}, CR: ${
                ...
                //microBolus > 0.3 //not used except rsn049
                    ...
                    if (Delta >= 1.0 * 18 &&
                        ...
                        if (bg > 8.8 * 18) {
                            microBolus = microBolus * 0.5
                            rT.reason.append("microBolus = microBolus * 0.5 ; microBolus = ${microBolus} ")
                            rT.reason.append(" CHANGED SIZE 0.502 for moderate fast rise 0.502 ")
                        } else if (bg > 8.0 * 18) {
                        ...
                        if (bg > 8.8 * 18) {
                            ...
                            rT.reason.append("smbUn 0.507 for 0.035 * max_iob microBolus = ${microBolus} ")
                        }
                    }
                        ...
                        Delta < 0.35 * 18
                            ...
                            if ( microBolus > 0.035 * max_iob ) {
                                ...
                                rT.reason.append(" CHANGED SIZE 0.408 for early fast rise 0.408 ")
                        } else {
                                rT.reason.append("smbUn 0.408 for 0.035 * max_iob microBolus = ${microBolus} ")
                            }
...
035058batt DetermineBasalAutoISF.kt
 */