...
class DetermineBasalAutoISF @Inject constructor(
    ...
    fun determine_basal(
        ...
        if (autoIsfMode) {
            consoleError.add("----------------------------------")
            consoleError.add("start AutoISF ${profile.autoISF_version} __ cl049")
            consoleError.add("----------------------------------")
        ...
        rT.reason.append(
            " cl049 COB: ${round(meal_data.mealCOB, 1).withoutZeros()}, Dev: ${convert_bg(deviation.toDouble())}, BGI: ${convert_bg(bgi)}, ISF: ${convert_bg(sens)}, CR: ${
...
// =====================================================
                    ...
                    //microBolus > 0.3 //not used except cl049
                ) {
...
/*/ =====================================================
// FAST RISE SECONDARY CAP. .not used except cl049not used except gpt047
// =====================================================
...
cl049 DetermineBasalAutoISF.kt
 */