...
class AutomationStateValuesDialog : DaggerDialogFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.let { stateName = it.getString("stateName", "") }
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val stateEntry = automationStateService.getAllStates().find { it.first == stateName }
        ...
        binding.okButton.setOnClickListener {
            ...
            if (isNewState || currentStateValue.isEmpty()) {
                try { automationStateService.setState(stateName, stateValues.first()) }
                catch (e: Exception) { ToastUtils.showToastInUiThread(context, e.message ?: "Error setting state") }
            }
    ...
    inner class StateValuesAdapter(private val onDelete: (Int) -> Unit) :
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
            val binding = AutomationStateValueItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        ...
        inner class ViewHolder(val binding: AutomationStateValueItemBinding) : RecyclerView.ViewHolder(binding.root)
    }

    companion object {
        fun newInstance(stateName: String) = AutomationStateValuesDialog().apply {
            arguments = Bundle().apply { putString("stateName", stateName) }
        }
    }
}