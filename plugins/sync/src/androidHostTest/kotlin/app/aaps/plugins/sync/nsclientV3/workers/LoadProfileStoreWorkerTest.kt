        ...
        TestListenableWorkerBuilder<LoadProfileStoreWorker>(context)
            .setWorkerFactory(object : WorkerFactory() {
                override fun createWorker(appContext: Context, workerClassName: String, workerParameters: WorkerParameters) =
                    LoadProfileStoreWorker(appContext, workerParameters, aapsLogger, fabricPrivacy, LoadProfileStoreRunner(aapsLogger, preferences, nsClientV3Plugin, dateUtil, nsIncomingDataProcessor, nsClientRepository))
            })
            .build()
