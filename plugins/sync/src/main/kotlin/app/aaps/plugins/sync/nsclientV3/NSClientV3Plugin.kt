        ...
        category.apply {
            ...
            if (config.AAPSCLIENT) {
                ...
                addPreference(PreferenceCategory(context).also { cat ->
                    ...
                    cat.addPreference(AdaptiveSwitchPreference(ctx = context, booleanKey = BooleanKey.FslUseUkfSmoothing, mutuallyExclusiveKey = BooleanKey.FslUseUkfLibreSpecialSmoothing, title = R.string.fsl_use_ukf_smoothing_title, summary = R.string.fsl_use_ukf_smoothing_summary))
                    cat.addPreference(
