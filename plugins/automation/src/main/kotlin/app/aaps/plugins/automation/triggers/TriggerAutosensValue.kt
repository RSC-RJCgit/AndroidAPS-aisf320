...
class TriggerAutosensValue(injector: HasAndroidInjector) : Trigger(injector) {
    ...
    override fun shouldRun(): Boolean {
        ...
        if (comparator.value.check(autosensData.autosensResult.ratio, autosens.value / 100.0, 0.001)) {
            aapsLogger.debug(LTag.AUTOMATION, "Ready for execution: " + friendlyDescription())
            return true
        }
        aapsLogger.debug(LTag.AUTOMATION, "NOT ready for execution: " + friendlyDescription())
    ...
    override fun friendlyDescription(): String =
        rh.gs(R.string.autosenscompared, comparator.value.shortSymbol, autosens.value)
