...
class ImportExportPrefsImpl @Inject constructor(
    ...
    // Compose export support ΓÇö discrete steps
    ...
    // Legacy export ΓÇö uses dialogs via uiInteraction (kept for old UI)
    ...
    // Compose import support ΓÇö discrete steps, no UI
    ...
    override fun decryptImportFile(file: PrefsFile, password: String): ImportDecryptResult {
        return try {
            ...
            // Check if encryption metadata has ERROR ΓåÆ wrong password
