...
class TherapyEventDataPoint(
    ...
    // Flat white for all types, matching StepsStackedDataPoint (the stacked step labels at the bottom
    // of the graph) — was previously a different theme-attribute color per TE.Type; unified per user
    // request so top (careportal notes) and bottom (steps) labels read consistently.
