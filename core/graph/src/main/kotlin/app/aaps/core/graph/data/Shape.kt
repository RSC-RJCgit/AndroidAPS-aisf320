...
enum class Shape {
    ...
    L1_DELTA_POINT // Libre 1-min delta label attached directly to the current Libre graph point (no fixed row) — same 45°-rotated style as GENERAL's drawLabel45Right, no circle, own color (red)
}
