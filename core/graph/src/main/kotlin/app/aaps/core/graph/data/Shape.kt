...
enum class Shape {
    ...
    L5_DELTA_POINT // "L5=<libre 5-min delta>" label attached directly to the current Libre graph point (no fixed row) — same 45°-rotated style as GENERAL's drawLabel45Right, no circle, own color (orange)
}
