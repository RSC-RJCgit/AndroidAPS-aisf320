 ...
 * updated by hand whenever OpenAPSAutoISFPlugin.kt gains/loses a readyToRun()/markRun() key (last synced 2026-09-19:
 * 45 keys added, 183 total; LibreUkf2ToggleTT, LowBgTierAReset, VirtualPseudoWizard are kept although no literal
 * readyToRun() call remains for them). Extracted via:
...
object CodedAutomationNames {
    ...
    val KEYS: List<String> = listOf(
        ...
        "EveningIobCeiling", "EveningTH", "ExerciseLimitAcce", "ExportSettingsPodActivation", "Extra50",
        ...
        "LowBgTierAResetScan", "MJ2old", "MJ3old", "MJ4", "MJ5", "MJoff", "MJrecentCurrProfAcce", "MildBoostDownTT",
        ...
        "SteroidTurnOffActionTT", "StuckHighRescue", "Sub75HeavyDelivery", "T80Off3ok", "TT57Reversal", "Test3",
        "Tier3BoostToggleTT", "TodOffset0002DownTT", "TodOffset0002UpTT", "TodOffset0204DownTT", "TodOffset0204UpTT",
