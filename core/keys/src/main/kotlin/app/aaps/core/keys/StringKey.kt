...
enum class StringKey(
    ...
    // Build.MODEL of the one phone allowed to send coded-location SMS / CarePortal notes / AnyDesk.
    // Blank = nobody sends. A phone whose model does not match does not notify. List2 / Settings write this.
