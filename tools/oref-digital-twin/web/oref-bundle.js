(() => {
  ...
  var require_determine_basal = __commonJS({
    "node_modules/oref0/lib/determine-basal/determine-basal.js"(exports, module) {
      ...
      function calculate_expected_delta(target_bg, eventual_bg, bgi) {
        ...
        return (
          /* expectedDelta */
          round(bgi + target_delta / five_min_blocks, 1)
        );
      }
      ...
      var determine_basal2 = function determine_basal3(glucose_status, currenttemp, iob_data, profile, autosens_data, meal_data, tempBasalFunctions2, microBolusAllowed, reservoir_data, currentTime) {
        var rT = {};
        var deliverAt = /* @__PURE__ */ new Date();
        if (currentTime) {
        ...
        var systemTime = /* @__PURE__ */ new Date();
        if (currentTime) {
        ...
        if (microBolusAllowed && currenttemp && iob_data.lastTemp && currenttemp.rate !== iob_data.lastTemp.rate && lastTempAge > 10 && currenttemp.duration) {
          ...
          return tempBasalFunctions2.setTempBasal(0, 0, profile, rT, currenttemp);
        }
        ...
        rT = {
          ...
          // autosens ratio (fraction of normal basal)
        };
        var COBpredBGs = [];
        var IOBpredBGs = [];
        var UAMpredBGs = [];
        ...
        if (bg < threshold && iob_data.iob < -profile.current_basal * 20 / 60 && minDelta > 0 && minDelta > expectedDelta) {
          ...
          return tempBasalFunctions2.setTempBasal(0, durationReq, profile, rT, currenttemp);
        }
        ...
        if (eventualBG < min_bg) {
          ...
          if (minDelta > expectedDelta && minDelta > 0 && !carbsReq) {
            if (naive_eventualBG < 40) {
              ...
              return tempBasalFunctions2.setTempBasal(0, 30, profile, rT, currenttemp);
            }
            ...
            if (currenttemp.duration > 15 && round_basal(basal, profile) === round_basal(currenttemp.rate, profile)) {
              ...
              return tempBasalFunctions2.setTempBasal(basal, 30, profile, rT, currenttemp);
            }
          }
          ...
          if (insulinScheduled < minInsulinReq - basal * 0.3) {
            ...
            return tempBasalFunctions2.setTempBasal(rate, 30, profile, rT, currenttemp);
          }
          if (typeof currenttemp.rate !== "undefined" && (currenttemp.duration > 5 && rate >= currenttemp.rate * 0.8)) {
            ...
            if (rate <= 0) {
              ...
              if (durationReq > 0) {
                ...
                return tempBasalFunctions2.setTempBasal(rate, durationReq, profile, rT, currenttemp);
              }
            } else {
        ...
        if (iob_data.iob > max_iob) {
          ...
          var maxSafeBasal = tempBasalFunctions2.getMaxSafeBasal(profile);
      ...
      module.exports = determine_basal2;
    }
  });

  // node_modules/oref0/lib/basal-set-temp.js
  var require_basal_set_temp = __commonJS({
    "node_modules/oref0/lib/basal-set-temp.js"(exports, module) {
      ...
      var tempBasalFunctions2 = {};
      tempBasalFunctions2.getMaxSafeBasal = function getMaxSafeBasal(profile) {
      ...
      tempBasalFunctions2.setTempBasal = function setTempBasal(rate, duration, profile, rT, currenttemp) {
        var maxSafeBasal = tempBasalFunctions2.getMaxSafeBasal(profile);
        var round_basal = require_round_basal();
        if (rate < 0) {
          rate = 0;
      ...
      module.exports = tempBasalFunctions2;
    }
  });
  ...
  function runOne(req) {
    const currentTime = req.currentTime != null ? new Date(req.currentTime) : /* @__PURE__ */ new Date();
    return (0, import_determine_basal.default)(
      req.glucose_status,
      req.currenttemp,
      req.iob_data,
      req.profile,
      req.autosens_data || { ratio: 1 },
      req.meal_data || {},
      import_basal_set_temp.default,
